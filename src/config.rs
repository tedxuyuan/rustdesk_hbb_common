...
lazy_static::lazy_static! {
    ...
    pub static ref APP_NAME: RwLock<String> = RwLock::new("RaresoftSupport".to_owned());
    ...
    pub static ref DEFAULT_SETTINGS: RwLock<HashMap<String, String>> = {
        ...
        m.insert(keys::OPTION_API_SERVER.to_string(), "https://rs.raresoft.net".to_string());
        RwLock::new(m)
    };
...
pub const LINK_DOCS_HOME: &str = "https://www.raresoft.net";
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["rs.raresoft.net"];
pub const RS_PUB_KEY: &str = "c1P3wTH4uJDP3Pbni0dMMe4UO1SeUnRAg4OFMQwPO2c=";
